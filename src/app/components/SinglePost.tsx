...
export function EmojiBox(){
    ...
    return(
        <div className="absolute w-[342] h-[325px] bg-white shadow-[0_4px_12px_rgba(0,0,0,.15)] p-2 overflow-y-scroll rounded-lg z-50 bottom-10">
                ...
                return(
                    <div key={index} className="mb-4">
                        ...
                        <div className="flex flex-wrap">
                            ...
                            <span key={i} className="size-[44px] items-center justify-center flex text-[32px] hover:bg-zinc-200 cursor-pointer">{emoji}</span>
                            ))}
                        </div>
                        </div>
                )
