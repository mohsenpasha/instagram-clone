...
export default function ReelPage(){
    ...
    const newUrl = useRef('http://localhost:8000/reels/' + currentUser.username)
    ...
    useEffect(()=>{
        ...
        setIsLoading(true)
        dispatch(changePostListUrl(`http://localhost:8000/reels/${currentUser.username}`))
    ...
    return(
        <div>
            <PostList postList={postList} isReel={true} />
        </div>
    )
}